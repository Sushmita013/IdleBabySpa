...
public class PhotoshootTab : MonoBehaviour
{
    // Public variables
    ...
    public List<GameObject> plantLight; // List of plant room lamps 
    public List<GameObject> plantLight2; // List of plant room lamps 
    public List<GameObject> plantLight3; // List of plant room lamps 
    public GameObject prop; // List of table for level 1
    public List<GameObject> prop2; // List of table for level 2 
    public List<GameObject> prop3; // List of table for level 3 
    ...
    public ParticleSystem raysEffect;   // Particle effect for upgrades (level 63)
    ...
    public void VisualUpgrade(int level)
    {
        ...
        switch (level)
        {
            case 13:
                upgradeEffect1.Play();
                plantLight[0].SetActive(true);
                plantLight[0].transform.DOScale(new Vector3(1, 1, 1), 1f);
                raysEffect.Play();
                break;
            case 25:
                SizeExpansion();
    ...
    public void SizeExpansion()
    {
        ...
        plantLight[1].SetActive(true);
        plantLight[1].transform.DOScale(new Vector3(1, 1, 1), 1f);
        Destroy(prop.gameObject);
        foreach (GameObject item in prop2)
        {
            item.SetActive(true);
    ...
    public void SizeExpansion2()
    {
        ...
        plantLight2[2].SetActive(true);
        plantLight2[2].transform.DOScale(new Vector3(1, 1, 1), 1f);
        foreach (GameObject item in prop2)
        {
            Destroy(item);
        }
        foreach (GameObject item in prop3)
        {
            item.SetActive(true);
            item.transform.DOScale(new Vector3(1, 1, 1), 1f);
        }
    ...
    public void LampPlantUpgrade()
    {
        ...
        upgradeEffect1.Play();
        upgradeEffect3.Play();
        Destroy(plantLight[0].gameObject);
        foreach (GameObject item in plantLight)
        {
            Destroy(item);
        }
        foreach (GameObject item in plantLight2)
        {
            item.SetActive(true);
            item.transform.DOScale(new Vector3(1, 1, 1), 1f);
        }
    ...
    public IEnumerator LampPlantUpgrade1()
    {
        ...
        foreach (GameObject item in plantLight3)
        {
            item.SetActive(true);
            item.transform.DOScale(new Vector3(1, 1, 1), 1f);
        }
