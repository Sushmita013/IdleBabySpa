...
public class WaterTrainingTab : MonoBehaviour
{
    // Public variables
    ...
    public List<GameObject> shelfWallDeco; // List of plant room lamps 
    public List<GameObject> shelfWallDeco2; // List of plant room lamps 
    public List<GameObject> shelfWallDeco3; // List of plant room lamps 
    public GameObject tub; // List of table for level 1
    public List<GameObject> tub2; // List of table for level 2 
    public List<GameObject> tub3; // List of table for level 3 
    ...
    public void VisualUpgrade(int level)
    {
        ...
        switch (level)
        {
            case 13:
                upgradeEffect1.Play();
                shelfWallDeco[0].SetActive(true);
                shelfWallDeco[0].transform.DOScale(new Vector3(1, 1, 1), 1f);
                break;
            case 25:
                SizeExpansion();
                break;
    ...
    public void SizeExpansion()
    {
        ...
        shelfWallDeco[1].SetActive(true);
        shelfWallDeco[1].transform.DOScale(new Vector3(1, 1, 1), 1f);
        Destroy(tub.gameObject);
        foreach (GameObject item in tub2)
        {
            item.SetActive(true);
    ...
    public void SizeExpansion2()
    {
        ...
        shelfWallDeco2[2].SetActive(true);
        shelfWallDeco2[2].transform.DOScale(new Vector3(1, 1, 1), 1f);
        foreach (GameObject item in tub2)
        {
            Destroy(item);
        }
        foreach (GameObject item in tub3)
        {
            item.SetActive(true);
            item.transform.DOScale(new Vector3(1, 1, 1), 1f);
        }
    ...
    public void LampPlantUpgrade()
    {
        ...
        upgradeEffect1.Play();
        upgradeEffect3.Play();
        Destroy(shelfWallDeco[0].gameObject);
        foreach (GameObject item in shelfWallDeco)
        {
            Destroy(item);
        }
        foreach (GameObject item in shelfWallDeco2)
        {
            item.SetActive(true);
            item.transform.DOScale(new Vector3(1, 1, 1), 1f);
        }
    ...
    public IEnumerator LampPlantUpgrade1()
    {
        ...
        foreach (GameObject item in shelfWallDeco3)
        {
            item.SetActive(true);
            item.transform.DOScale(new Vector3(1, 1, 1), 1f);
        }
