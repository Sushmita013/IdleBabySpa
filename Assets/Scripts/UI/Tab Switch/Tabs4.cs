...
public class Tabs4 : MonoBehaviour
{
    public List<ButtonSwitch> tabs; // Reference to the ButtonTabsChange scripts attached to buttons
    ...
    public void HandleButtonStateChange(ButtonSwitch button)
    {
        ResetPanels();
