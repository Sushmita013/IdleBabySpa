...
public class Tabs6 : MonoBehaviour
{
    public List<ButtonChange1> tabs; // Reference to the ButtonTabsChange scripts attached to buttons
    ...
    public void HandleButtonStateChange(ButtonChange1 button)
    {
        ResetPanels();
